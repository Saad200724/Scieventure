...
const Projects: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Collaborative Projects | ScienceBridge Bangladesh</title>
        <meta name="description" content="Participate in collaborative science projects across Bangladesh. Join environmental monitoring, renewable energy, and astronomy projects." />
      </Helmet>
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-4">Collaborative Projects</h1>
          <p className="text-gray-600 mb-6">
            Join ongoing science projects across Bangladesh. Collaborate with other students and researchers 
            to contribute to real scientific research and community initiatives.
          </p>
