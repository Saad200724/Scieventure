...
const Resources: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Offline Learning Resources | ScienceBridge Bangladesh</title>
        <meta name="description" content="Download scientific resources for offline learning, including lab manuals, formula handbooks, and study guides." />
      </Helmet>
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-4">Offline Learning Resources</h1>
          <p className="text-gray-600 mb-6">
            Access and download high-quality educational materials for offline study. These resources 
            are designed for areas with limited internet connectivity and can be used for self-study 
